/**
 * Factory method for instantiating SpreadsheetsDBManager
 * @param {string} url Target SpreadSheet URL
 * @param {string} sheet_name　Target sheet name
 * @return {SpreadsheetsDBManager}
 */
function createSpreadsheetsDBManager(url,sheet_name) {
...
(function(global){
  ...
  global.SpreadsheetsDBManager = SpreadsheetsDBManager;
})(this);